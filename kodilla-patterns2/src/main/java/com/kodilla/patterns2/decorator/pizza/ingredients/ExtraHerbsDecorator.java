...
public class ExtraHerbsDecorator extends AbstractPizzaOrderDecorator {
    public ExtraHerbsDecorator(PizzaOrder pizzaOrder) {
        super(pizzaOrder);
    }
    @Override
    ...
    public String getDescription() {
        return super.getDescription() + " + extra herbs";
    }
}
